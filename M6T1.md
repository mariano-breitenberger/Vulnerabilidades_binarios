...
a. msfvenom: comando de metasploit para generar payloads.
...
f. --bad-chars "\x00"
g. --bad-chars "\x00": excluye el byte nulo (\x00) del payload
h. -e x86/shikata_ga_nai: usa el codificador shikata_ga_nai para ofuscar el payload, haciéndolo más difícil de detectar por antivirus.
i: --format python: genera el payload como un script Python
