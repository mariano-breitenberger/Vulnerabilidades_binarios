...
### IDA: También es un debugger pero tiene un apartado para ver un pseudo código de lo que es el ensamblador. Para descargarlo puedes ir a:
...
### Mona: esta es una herramienta que podemos importar en Immunity para facilitarnos la explotación. Para descargarlo puedes ir a:
